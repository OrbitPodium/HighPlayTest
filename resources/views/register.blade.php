        ...
        <div class="col-xs-12 col-sm-5 col-md-4 login-sidebar">
            ...
            <div class="login-container">
                ...
                <form action="{{ route('register') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="form-group form-group-default" id="labelnome">
                        <label>Nome</label>
                        <div class="controls">
                            <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="O seu nome.." class="form-control" required>
                         </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-block login-button">
                        <span class="signingin hidden"><span class="voyager-refresh"></span> A registar...</span>
                        <span class="signin">Registar</span>
                    </button>
              ...
              <p>Já tenho registo. <a href="{{route('voyager.login')}}">Entrar aqui.</a></p>
